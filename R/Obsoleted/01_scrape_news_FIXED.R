...
# FIXED: Date parsing now correctly handles Google News (RFC 822) and Yahoo Finance (ISO 8601)
  ...
  tryCatch({
    ...
    result <- tibble(
      ...
      mutate(
        ...
        # Google News format: "Fri, 31 Oct 2025 01:00:14 GMT" 
        # Yahoo Finance format: "2025-10-31T23:25:55Z"
        pub_datetime = parse_date_time(
          pub_date_raw,
          orders = c("a, d b Y H:M:S z", "Ymd HMS"),
          tz = "UTC"
        ),
